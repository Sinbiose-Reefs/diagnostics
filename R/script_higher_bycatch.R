...
# sensitivity analysis: 5% of the year catch
...
dir.create(here ("output", "output_higher_bycatch"))
...
# arrange plots
pdf (here ("output", "output_higher_bycatch","fisheries_composition.pdf"),height=7,width=7)
...
pdf (here ("output", "output_higher_bycatch","fisheries_composition_region.pdf"),height=8,width=8)
