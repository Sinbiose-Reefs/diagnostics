...
# analysis without data transformation (Hellinger)
...
dir.create(here ("output", "output_no_hellinger"))
...
# trait data (Quimbayo et al database)
...
require(vegan)
dist_composition <- vegdist (year_composition_filtered, 
                                method = "bray",
                             na.rm=T)
...
correlation <-data.frame( cor (year_composition_filtered,
                    pcoa_fish_year[,1:2],
                    method = "pearson"))
...
# arrange plots
pdf (here ("output","output_no_hellinger", "fisheries_composition.pdf"),height=7,width=7)
...
pdf (here ("output","output_no_hellinger", "fisheries_composition_region.pdf"),height=8,width=8)
